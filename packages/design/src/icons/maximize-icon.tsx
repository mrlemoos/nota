...
/** Corner brackets that push outward on hover — "make this bigger". */
const MaximizeIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        <motion.path className="corner-tl" d="M8 3H5a2 2 0 0 0-2 2v3" />
        <motion.path className="corner-tr" d="M16 3h3a2 2 0 0 1 2 2v3" />
        <motion.path className="corner-br" d="M21 16v3a2 2 0 0 1-2 2h-3" />
        <motion.path className="corner-bl" d="M3 16v3a2 2 0 0 0 2 2h3" />
      </motion.svg>
    );
  },
);
